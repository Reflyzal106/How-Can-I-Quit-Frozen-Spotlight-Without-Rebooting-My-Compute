# [SOLVED] How-Can-I-Quit-Frozen-Spotlight-Without-Rebooting-My-Compute
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/how-can-i-quit-frozen-spotlight-without-rebooting-my-compute)
>
...
Press Command + Option + Esc to open the Force Quit menu, then select Spotlight and click 'Force Quit'. Alternatively, use Activity Monitor to find the Spotlight process and force quit it.
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/how-can-i-quit-frozen-spotlight-without-rebooting-my-compute)**
